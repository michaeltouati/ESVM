...
ESVM (ElectroStatic Vlasov-Maxwell) is a Vlasov-Maxwell Fortran 90 Eulerian code parallelized using OpenMP allowing for the study of collisionless plasmas. The different finite volume numerical advection schemes @Godunov:1959 implemented in the code in order to discretize the Vlasov equation are the :
