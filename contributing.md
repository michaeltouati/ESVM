...
for the test to be fast and a text file entitled 'output' containing the terminal output generated by the corresponding simulation run using your new feature. For this, add in the bash script 'test-gen.sh' located in 'test-cases/Tests' a line
```sh
