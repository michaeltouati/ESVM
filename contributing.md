...
for the test to be fast and a text file entitled 'output' containing the terminal output generated by the corresponding simulation run using your new feature. For this, you can just type from the directory 'test-cases/Tests/New-feature/my-new-feature'
```sh
../../../.././esvm > output
```
Finally, add in the makefile at the section ```## TESTING ##``` the following line
```sh
